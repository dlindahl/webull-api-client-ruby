...
module WebullApiClient
  class GetBatchStockOptionsResponse
    ...
    def self.openapi_types
      {
        ...
        :'ask_list' => :'Array<OptionPriceList>',
        :'belong_ticker_id' => :'Integer',
        :'bid_list' => :'Array<OptionPriceList>',
        :'change' => :'String',
        :'change_ratio' => :'String',
        :'close' => :'String',
        :'currency_id' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'trade_stamp')
        self.trade_stamp = attributes[:'trade_stamp']
      end
