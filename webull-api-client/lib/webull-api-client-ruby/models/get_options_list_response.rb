...
module WebullApiClient
  class GetOptionsListResponse
    ...
    def self.openapi_types
      {
        :'ask_list' => :'Array<GetOptionsListResponseAskList>',
        :'bid_list' => :'Array<GetOptionsListResponseAskList>',
        :'change' => :'String',
        :'change_ratio' => :'String',
        :'close' => :'String',
        ...
        :'expire_date_list' => :'Array<GetOptionsListResponseExpireDateList>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WebullApiClient::GetOptionsListResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WebullApiClient::GetOptionsListResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [ask_list, bid_list, change, change_ratio, close, dis_exchange_code, dis_symbol, exchange_code, expire_date_list].hash
    end
