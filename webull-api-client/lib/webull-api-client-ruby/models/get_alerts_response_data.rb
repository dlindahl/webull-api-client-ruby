  ...
  class GetAlertsResponseData
    ...
    def self.openapi_types
      {
        ...
        :'dis_symbol' => :'String',
        :'event_warning' => :'GetAlertsResponseEventWarning',
        ...
        :'ticker_type' => :'Integer',
        :'ticker_warning' => :'GetAlertsResponseTickerWarning',
        :'tiny_name' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WebullApiClient::GetAlertsResponseData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WebullApiClient::GetAlertsResponseData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'event_warning')
        self.event_warning = attributes[:'event_warning']
      end
      ...
      if attributes.key?(:'ticker_warning')
        self.ticker_warning = attributes[:'ticker_warning']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ticker_warning == o.ticker_warning &&
    ...
    def hash
      [dis_exchange_code, dis_symbol, event_warning, exchange_code, exchange_trade, region_id, show_code, ticker_id, ticker_name, ticker_symbol, ticker_type, ticker_warning, tiny_name].hash
    end
