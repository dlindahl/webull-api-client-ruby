...
module WebullApiClient
  class GetAccountsResponseV5Accounts
    ...
    attr_accessor :remind_modify_pwd
    ...
    def self.attribute_map
      {
        ...
        :'warning' => :'warning',
        :'remind_modify_pwd' => :'remindModifyPwd',
    ...
    def self.openapi_types
      {
        ...
        :'unrealized_profit_loss_base' => :'String',
        :'warning' => :'Boolean',
        :'remind_modify_pwd' => :'Boolean',
        :'account_members' => :'Array<GetAccountsResponseV5AccountMembers>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WebullApiClient::GetAccountsResponseV5Accounts` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WebullApiClient::GetAccountsResponseV5Accounts`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'remind_modify_pwd')
        self.remind_modify_pwd = attributes[:'remind_modify_pwd']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          warning == o.warning &&
          remind_modify_pwd == o.remind_modify_pwd &&
    ...
    def hash
      [sec_account_id, broker_id, account_type, broker_account_id, currency, currency_id, pdt, professional, show_upgrade, total_cost, net_liquidation, unrealized_profit_loss, unrealized_profit_loss_rate, unrealized_profit_loss_base, warning, remind_modify_pwd, account_members, open_order_size].hash
    end
