...
# Unit tests for WebullApiClient::WebApiApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WebApiApi' do
  before do
  ...
  describe 'test an instance of WebApiApi' do
    it 'should create an instance of WebApiApi' do
      expect(@api_instance).to be_instance_of(WebullApiClient::WebApiApi)
    end
  end
